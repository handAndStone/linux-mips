...
/*******************************************
 *	len is length of actual data; 
 *	iph is length if ip packets head;
 *	real length of  ip packets head is iph * 4
 * *****************************************/
	tcplen = (*pskb)->len - iph->ihl*4;


/**********************************************
 *	Tcp packet is following IP packet.
 *********************************************/
	...
	/* Since it passed flags test in tcp match, we know it is is
	   ...
	   badly. --RR */
/*****************************************************
 *	doff * 4  is the  value of Tcp head offset 
 * ************************************************/
...
/***************************************************************************
 *	IPT_TCPMSS_CLAMP_PMTU = 0xffff,
 *	struct dst_entry dst, describe the field.
 **************************************************************************/
